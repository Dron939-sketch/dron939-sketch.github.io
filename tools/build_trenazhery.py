...
GAMES: dict[str, dict] = {
    ...
    "opora": dict(
        icon="🗿", name="Опора",
        text="Противник — внутренний критик: после ошибки или похвалы он "
             "давит приговорами и кривой бухгалтерией («успех — везение, "
             "провал — ты»). Задача — отвечать не «нет, я молодец», а "
             "фактами, честным вкладом и тоном друга.",
        course=("/blog/lektorij/samoocenka/", "Самооценка и уверенность"),
    ),

    "lestnica": dict(
        icon="🪜", name="Лестница",
        text="Конструктор лестницы экспозиции — главного инструмента против "
             "страхов и фобий: ступени с оценкой СУД, проверка стройки "
             "(разрывы, ступени-близнецы, спрятанные подстраховки — их ищет "
             "Фреди) и лист побед по заходам.",
        course=("/blog/lektorij/strahi-i-fobii/", "Страхи и фобии"),
    ),
...
GROUPS: list[tuple[str, str, str, list[str]]] = [
    ...
    ("sostoyanie", "Мысли, чувства, поведение",
     ...
     ["mysl", "chuvstva", "skazhinet", "rol", "klin", "alfavit", "istoria", "spiral", "perehod", "lestnica", "opora"]),
