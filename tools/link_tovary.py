...
PRODUCTS = {
    ...
    "trening-gipnoz": dict(
        ...
        body="Курс «Разговорный гипноз», пакет «Стандартный»: 38 видео плюс "
             "комплект на бумаге — книга «Матчасть», блокнот с заданиями, "
             "колода для отработки и две схемы. Ваши разговоры разбираем "
             "вместе.",
