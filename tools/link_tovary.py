...
RULES = [
    ...
    # УБ-9, профессиональный рост: «как повысить компетенцию» 445 показов.
    # Догматик копит знания в одной рамке — ему нужна не ещё одна книга по
    # профессии, а книга про смену рамки. Решение 11.09.2026.
    (r"компетенц|kompetenc|квалификац|kvalifikac|углубить[- ]знани|"
     r"стать[- ]эксперт|не[- ]отстать[- ]от[- ]професс", "kniga-konceptikon"),
