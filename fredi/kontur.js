  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showLgenijGame&&window.showLgenijGame()"><span class="em">🧲</span>Ленивый гений <span style="font-size:.72rem;color:#34d399">🆕 цель + путь</span><small>Тренажёр двигателя: хотеть в 10 раз больше — делать в 10 раз меньше. Два хода за раунд: подними планку робкой цели и найди к ней ленивый рычаг — путь, где результат почти достаётся сам (идеальный результат из ТРИЗ). Фреди оценит амбицию × дешевизну пути и покажет твой перекос: гений, герой, хитрец или планктон.</small></button>' +
