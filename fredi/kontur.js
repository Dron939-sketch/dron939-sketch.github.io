  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showLazejkaGame&&window.showLazejkaGame()"><span class="em">🕳️</span>Лазейка <span style="font-size:.72rem;color:#5eead4">🆕 буква и дух</span><small>Правило описывает поведение, а мотив описать не может — поэтому дыра есть всегда. Сначала Фреди даёт правило и твою цель: возьми своё, не нарушив формулировку. Потом наоборот — правило пишешь ты, а Фреди играет того, кто хочет его обойти. Три режима победы: по букве, по духу и начисто. Восемь контекстов, от планёрки до «после одиннадцати телефон не беру».</small></button>' +
