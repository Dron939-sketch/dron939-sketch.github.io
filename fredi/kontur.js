  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showParusGame&&window.showParusGame()"><span class="em">⛵</span>Парус <span style="font-size:.72rem;color:#34d399">🆕 тигр и торт</span><small>Тренажёр к курсу «Парус»: не строить с нуля, а вставать в то, что уже движется. Пять рейсов: увидеть поток → найти точку простоя → проверить идею тремя условиями → собрать движущую пару «тигр и торт» → придумать свой парус под задачу (Фреди разберёт). От выбора из вариантов к собственным решениям.</small></button>' +
