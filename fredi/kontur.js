  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showDotogokakScreen&&window.showDotogokakScreen()"><span class="em">🎬</span>До того, как <span style="font-size:.8rem;color:#f0b24b">💎 Premium</span><small>Тренажёр поведенческих сценариев. 100 ситуаций в 8 сегментах — от переговоров до экзистенциальных. Мысленно репетируй ДО того, как случилось — чтобы в реальности был готовый паттерн.</small></button>' +
