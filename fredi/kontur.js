  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showDvaPotokaGame&&window.showDvaPotokaGame()"><span class="em">🎙️</span>Два потока<small>Голосовой тренажёр двух уровней мышления: беглость и пересказ + порождение на ходу. Тост, экспромт, сказка-конструктор — говоришь и думаешь одновременно.</small></button>' +
