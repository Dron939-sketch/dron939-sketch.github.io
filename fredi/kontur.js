  ...
  function showKonturScreen() {
    ...
    c.innerHTML =
      '<div class="kt-wrap">' +
        ...
        '<button class="kt-btn" onclick="window.showLazejkaGame&&window.showLazejkaGame()"><span class="em">🕳️</span>Лазейка <span style="font-size:.72rem;color:#5eead4">🆕 буква и дух</span><small>Читать систему правил и видеть, что она на самом деле разрешает, — это навык. Игра не судит, как вы им пользуетесь. «Гонка»: Фреди даёт правило, вы находите ход — автор подтягивает формулировку под ваш ход — вы ищете снова, и текст правила разбухает на глазах. «Заплатка»: обратное кресло, правило пишете вы. Категории прохождения как в спидраннинге, у каждой свой рекорд.</small></button>' +
