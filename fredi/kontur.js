...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      '.kt-wrap{max-width:720px;margin:0 auto;padding:18px 16px 80px;color:var(--text-primary,#1a1a1a)}',
      '.kt-h1{font-size:1.5rem;font-weight:800;letter-spacing:-.01em;margin:6px 0 10px;line-height:1.15}',
      '.kt-lead{font-size:1rem;color:var(--text-secondary,#555);line-height:1.55;margin-bottom:16px}',
      '.kt-card{background:var(--surface,#fff);border:1px solid rgba(127,127,127,.16);border-radius:16px;padding:18px 18px;margin-bottom:12px}',
      '.kt-btn{display:block;width:100%;text-align:left;padding:16px 18px;border-radius:14px;border:1.5px solid rgba(127,127,127,.18);background:var(--surface,#fff);color:inherit;font:600 1rem Inter,sans-serif;cursor:pointer;margin-bottom:10px;transition:all .15s}',
      '.kt-btn:hover{border-color:#3A86FF;transform:translateY(-1px)}',
      '.kt-btn .em{font-size:1.4rem;margin-right:10px}',
      '.kt-btn small{display:block;font-weight:400;color:var(--text-secondary,#777);margin-top:3px;font-size:.85rem}',
      '.kt-primary{background:#3A86FF;color:#fff;border:none;text-align:center}',
      '.kt-primary:hover{background:#1d6fed}',
      '.kt-ghost{background:transparent;border:none;color:#3A86FF;font-weight:600;cursor:pointer;padding:10px;font-size:.95rem}',
      '.kt-opt{display:flex;gap:10px;align-items:flex-start;padding:12px 14px;border:1.5px solid rgba(127,127,127,.18);border-radius:12px;margin-bottom:8px;cursor:pointer;font-size:.96rem;line-height:1.4;background:var(--surface,#fff)}',
      '.kt-opt.sel{border-color:#3A86FF;background:rgba(58,134,255,.08)}',
      '.kt-opt .mk{flex:0 0 20px;height:20px;border:2px solid rgba(127,127,127,.3);border-radius:6px;margin-top:1px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:12px}',
      '.kt-opt.sel .mk{background:#3A86FF;border-color:#3A86FF}',
      '.kt-prog{height:6px;background:rgba(127,127,127,.15);border-radius:99px;overflow:hidden;margin-bottom:6px}',
      '.kt-prog>i{display:block;height:100%;background:linear-gradient(90deg,#3A86FF,#6366f1);width:0;transition:width .3s}',
      '.kt-plabel{font-size:12px;color:var(--text-secondary,#888);margin-bottom:16px}',
      '.kt-nav{display:flex;justify-content:space-between;gap:10px;margin-top:14px}',
      '.kt-q{font-size:1.2rem;font-weight:700;line-height:1.25;margin-bottom:4px}',
      '.kt-qh{font-size:.85rem;color:var(--text-secondary,#888);margin-bottom:14px}',
      ...
      '.kt-axis.t{background:rgba(245,158,11,.14);color:#b45309}',
      '.kt-axis.o{background:rgba(58,134,255,.14);color:#1d6fed}',
      ...
      '.kt-bar{height:6px;background:rgba(127,127,127,.15);border-radius:99px;overflow:hidden;margin:2px 0}',
      '.kt-bar>i{display:block;height:100%;border-radius:99px}',
      '.kt-decl{background:linear-gradient(135deg,#0B1220,#1a2444);color:#fff;border-radius:14px;padding:18px;margin:14px 0;line-height:1.5}',
      ...
      '.kt-msg.f{align-self:flex-start;background:rgba(58,134,255,.1);border-bottom-left-radius:4px}',
      '.kt-msg.u{align-self:flex-end;background:#3A86FF;color:#fff;border-bottom-right-radius:4px}',
      '.kt-msg.sys{align-self:center;background:transparent;color:var(--text-secondary,#999);font-size:.82rem;font-style:italic;text-align:center;max-width:95%}',
      '.kt-typing{align-self:flex-start;color:var(--text-secondary,#888);font-size:.85rem;font-style:italic;padding:6px 4px}',
      '.kt-inrow{display:flex;gap:8px;align-items:flex-end;margin-top:8px}',
      '.kt-ta{flex:1;resize:none;padding:12px 14px;border-radius:14px;border:1.5px solid rgba(127,127,127,.22);background:var(--surface,#fff);color:inherit;font:400 1rem Inter,sans-serif;max-height:140px;min-height:46px;line-height:1.4}',
      ...
      '.kt-chip{display:inline-block;padding:6px 12px;border-radius:20px;border:1.5px solid rgba(127,127,127,.2);margin:3px;font-size:.86rem;cursor:pointer;background:var(--surface,#fff)}',
      '.kt-chip.sel{border-color:#3A86FF;background:rgba(58,134,255,.1);color:#1d6fed;font-weight:600}'
    ].join('\n');
