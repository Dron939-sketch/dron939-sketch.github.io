...
function showPremiumLockPopup(modeName, opts) {
    ...
    const text = o.text || (isMode
        ...
        : 'Открывается с подпиской вместе с голосом, всеми режимами и памятью Фреди о каждом разговоре. Три дня полного Premium — 69 ₽, дальше 990 ₽ в месяц, отключается в один клик.');
