...
const DASH_QUESTIONS = [
    ...
    { q: 'Муж «чинит машину» в гараже по три часа. Это конец или он просто прячется?', who: 'Наталья, 37' },
    { q: 'Он не прячется в гараже — он просто не хочет меня видеть?',                  who: 'Вера, 35' },
    { q: 'Почему меня это задевает, если мы и так не разговариваем неделями?',         who: 'Алла, 43' },
    { q: 'Мы не ссоримся, но я смотрю на него и ничего не чувствую. Быт съел любовь?', who: 'Полина, 32' },
    { q: 'Любовь просто превратилась в привычку — сериалы под пиццу, и всё?',          who: 'Лидия, 29' },
    { q: 'Почему он так странно смотрит на мою самоуверенную подругу?',                who: 'Жанна, 36' },
    { q: 'Почему я вдруг начала проверять его телефон, хотя раньше было всё равно?',   who: 'Оксана, 33' },
    { q: 'Соврала по мелочи — а теперь он проверяет мой. Это шпионы или недоверие?',   who: 'Карина, 27' },
    { q: 'А если он уже ушёл мысленно и просто забыл собрать вещи?',                   who: 'Регина, 39' },
    { q: 'Он собрал вещи и ушёл со словами «я запутался». Ждать или выкинуть щётку?',  who: 'Тамара, 45' },
    { q: 'Пытаюсь флиртовать, чтобы вернуть искру, а он видит во мне своего пацана',   who: 'Нина, 30' },
    { q: 'Пытаюсь быть загадочной, а он думает, что я обиделась или туплю',            who: 'Алиса, 25' },
    { q: 'Я всё делаю правильно, но он всё равно молчит неделю после ссоры',           who: 'Галина, 41' },
    { q: 'Если я напишу первой — я проиграю или спасу эти отношения?',                 who: 'Кристина, 28' },
    { q: 'А если напишу, а он ответит, что ему просто нужно время?',                   who: 'Люба, 34' },
    { q: 'Почему меня до сих пор тянет к тем, кто даже не читает мои сообщения?',      who: 'Соня, 24' },
    { q: 'Бывший написал «привет» в два часа ночи. Отвечать или это ловушка?',         who: 'Евгения, 31' },
    { q: 'А если это не ловушка — а я сама хочу в неё попасть?',                       who: 'Милана, 26' },
    { q: 'Каждую пятницу накрывает тоска по бывшему, хотя я сама его бросила',         who: 'Рита, 29' },
    { q: 'Муж ушёл к другой полгода назад, а теперь звонит и ноет. Зачем?',            who: 'Валентина, 47' },
    { q: 'Он говорит, что любит, но не уходит от жены. Ждать или бежать?',             who: 'Элина, 33' },
    { q: 'Встречаться с кем-то из страха остаться одной на выходные — это выход?',     who: 'Зоя, 38' },
    { q: 'Встречаюсь с заботливым, а тянет к тому, кто меня игнорирует. Я больная?',   who: 'Аня, 26' },
    { q: 'Разум говорит «он хороший парень», а интуиция орёт «беги». Кого слушать?',   who: 'Инна, 35' },
    { q: 'Я саботирую хорошие отношения, потому что думаю: я этого не заслуживаю',     who: 'Ксения, 30' },
    { q: 'Знаю все психологические трюки, но всё равно пишу первой после игнора',      who: 'Диана, 28' },
    { q: 'Устала быть идеальной. Если покажу характер, он сбежит или проснётся?',      who: 'Маргарита, 40' },
    { q: 'Начала говорить «нет» и заниматься собой — и меня обвинили в эгоизме',       who: 'Лариса, 44' },
    { q: 'Мы вместе семь лет, и он больше не вызывает мурашек. Это конец?',            who: 'Яна, 32' },
    { q: 'Конец — это когда он говорит, что любит, но третий день не выносит мусор?',  who: 'Эльвира, 36' }
];
