...
(function () {
    try {
        ...
        var ROUTES = {
            ...
            lazejka: { fn: 'showLazejkaGame', src: 'lazejka.js', chat: 'kontur' },
            perehod: { fn: 'showPerehodGame', src: 'perehod.js', chat: 'kontur' }, // «Переход» — чьё решение вы выполнили // «Лазейка» — буква правила против его духа
