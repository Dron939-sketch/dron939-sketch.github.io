...
function _motApi()  { return window.CONFIG?.API_BASE_URL || ''; }
...
function _motTriggers() {
    const dos = [
        ['1.', 'Создайте ритуал начала дня — 5 минут только на себя'],
        ['2.', 'Разбейте большую цель на микро-шаги по 15 минут'],
        ['3.', 'Отмечайте даже маленькие победы — они формируют стрейк'],
        ['4.', 'Окружите себя людьми, которые верят в вас'],
        ['5.', 'Визуализируйте результат утром, пока ещё не включился внутренний критик']
