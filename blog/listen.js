    ...
    function renderServer(ready, v, signedUrl) {
        ...
        document.getElementById('lsn2Go').addEventListener('click', function () {
            ...
            function play(vv, url) {
                ...
                // «Лекция: дослушал» — цель Метрики 663996340 (26.09.2026).
                // Реклама на курсы Лектория без неё мерилась бы только входами:
                // человек, который дошёл до конца дорожки, и есть результат.
                // Один раз на страницу: после восстановления соединения
                // «ended» может прийти повторно.
                var endedSent = false;
