...
### Лист С — сделан (21.09.2026, стимульный контроль)

Исходник — `NanoBanana_…3-col (4).png` в корне репозитория. Ячейки разрезаны
на иконки 200×200 и обложки OG 1200×630 (квадрат по центру на размытом фоне
той же ячейки, `blog/og/`).

| ячейка | предмет | файл | где |
|---|---|---|---|
| 1 | свисток на кожаном шнурке | `stimulnyj-kontrol.webp`, `og/stimulnyj-kontrol.jpg` | иконка курса; OG курса и лекции 1 |
| 2 | латунный гироскоп | `avtopilot.webp`, `og/avtopilot.jpg` | тренажёр «Автопилот»; OG лекции 8 |
| 3 | чашка чая на краю стола | `og/rebenok-nelzya.jpg` | OG статьи «Ребёнок не останавливается после „нельзя“» |
| 4 | кнопка лифта | `og/stimul-lift.jpg` | OG лекции 3 (всплеск угасания) |
| 5 | детская кофта наизнанку | `og/stimul-kofta.jpg` | OG лекции 4 (подкрепление попытки) |
| 6 | упавшая башня из кубиков | `og/stimul-kubiki.jpg` | OG лекций 5–6 («а как ещё», «хочу, а нет») |
